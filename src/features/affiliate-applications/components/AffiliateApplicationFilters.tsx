...
interface AffiliateApplicationFiltersProps {
  selectedStatus: string;
  onStatusChange: (status: string) => void;
  searchTerm: string;
  onSearchChange: (search: string) => void;
  onClearFilters: () => void;
  table?: Table<AffiliateApplication> | null;
}

const AffiliateApplicationFilters = ({
  selectedStatus,
  onStatusChange,
  searchTerm,
  onSearchChange,
  onClearFilters,
}: AffiliateApplicationFiltersProps) => {
      ...
      <div className="flex flex-col lg:flex-row gap-4 lg:items-center lg:justify-between">
        ...
        <div className="flex flex-col sm:flex-row gap-4 flex-1">
          ...
          <div className="relative flex-1 max-w-sm">
            ...
            <Input
              id="search"
              placeholder="ابحث بالاسم، الإيميل، الكود..."
              value={searchTerm}
...
export default AffiliateApplicationFilters;