...
interface CertificateFiltersProps {
  ...
  onClearFilters: () => void;
  table?: Table<CourseCertificate> | null; // للتحكم في الأعمدة
}
...
function CertificateFilters({
  ...
  const types = ["الكل", "إنجاز", "تميز", "مشاركة"];

  const statuses = ["الكل", "نشط", "غير نشط", "مسودة"];

  const hasActiveFilters =
    selectedType !== "الكل" || selectedStatus !== "الكل" || searchTerm !== "";
