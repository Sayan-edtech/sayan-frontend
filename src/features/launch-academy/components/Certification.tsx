    ...
    <section className="py-14 sm:py-20">
      <div className="container">
        <div
          style={{
            background:
              "linear-gradient(147.29deg, rgba(15, 232, 232, 0.6) -277.01%, rgba(15, 232, 232, 0) 97.67%)",
          }}
          className="flex flex-col gap-10 md:gap-20 rounded-[36px] relative pt-16 pb-6 overflow-hidden"
        >
          {/* Top Right Image */}
