...
export const queryKeys = {
  ...
  courses: {
    ...
    mutations: {
      ...
      enroll: (courseId: string) => [...queryKeys.courses.all, "enroll", courseId] as const,
      unenroll: (courseId: string) => [...queryKeys.courses.all, "unenroll", courseId] as const,
      favorite: (courseId: string) => [...queryKeys.courses.all, "favorite", courseId] as const,
      unfavorite: (courseId: string) => [...queryKeys.courses.all, "unfavorite", courseId] as const,
    },
  },
};
