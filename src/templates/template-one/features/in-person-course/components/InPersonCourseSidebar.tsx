import InPersonCoursePricingCard from "./InPersonCoursePricingCard";
...
interface InPersonCourseSidebarProps {
  courseData: InPersonCourse;
}

export default function InPersonCourseSidebar({ courseData }: InPersonCourseSidebarProps) {
  return (
    <div className="hidden lg:block lg:col-span-1">
      <div className="sticky top-6 space-y-6">
        <InPersonCoursePricingCard courseData={courseData} />
