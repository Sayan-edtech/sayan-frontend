import { ShoppingCart, Heart, Share2, BookOpen, Play, Clock, Award, MessageSquare, Calendar, MapPin } from "lucide-react";
...
interface LiveCoursePricingCardProps {
  courseData: LiveCourse;
}

export default function LiveCoursePricingCard({ courseData }: LiveCoursePricingCardProps) {
  return (
        ...
        <div className="bg-gray-50 rounded-xl p-4">
          ...
          <div className="grid grid-cols-1 gap-3">
            {[
              ...
              { icon: Calendar, label: `${courseData.sessionsCount} جلسة مباشرة` },
