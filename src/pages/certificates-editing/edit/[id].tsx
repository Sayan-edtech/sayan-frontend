...
export default function EditCertificate() {
  ...
  const handlePositionChange = (
    element: string,
    position: Partial<CertificatePosition>
  ) => {
    setSettings((prev) => ({
      ...prev,
      positions: {
  ...
  const handleMouseMove = (e: React.MouseEvent) => {
    ...
    const elementWidth =
      settings.positions[activeElement as keyof typeof settings.positions]
        .width || 100;
    const elementHeight =
      settings.positions[activeElement as keyof typeof settings.positions]
        .height || 30;
    ...
    const pixelX = Math.max(
      0,
      Math.min((x / rect.width) * containerWidth, containerWidth - elementWidth)
    );
    const pixelY = Math.max(
      0,
      Math.min(
        (y / rect.height) * containerHeight,
              ...
              <div className="flex flex-col items-center">
                <div className="text-center mb-2">
                  <h2 className="text-base font-bold text-gray-900 mb-0">
                    معاينة الشهادة مع البيانات الحقيقية
                  </h2>
                  <p className="text-xs text-gray-600">
                    هذه معاينة حية للشهادة كما ستظهر للطلاب عند الإصدار
                  </p>
                </div>
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      ...
                      height: `${
                        settings.positions.academyName.height || 50
                      }px`,
                      fontSize: "24px",
                  ...
                  <div
                    ...
                    style={{
                      ...
                      height: `${
                        settings.positions.studentName.height || 60
                      }px`,
                      fontSize: "28px",
                      textShadow: "1px 1px 2px rgba(0,0,0,0.1)",
                    }}
                  ...
                  <div
                    ...
                    style={{
                      ...
                      height: `${
                        settings.positions.academyLogo.height || 100
                      }px`,
                    }}
                  >
                  ...
                  {settings.signature && (
                    <div
                      ...
                      style={{
                        ...
                        height: `${
                          settings.positions.signature.height || 60
                        }px`,
                      }}
                    >
                      <img
            ...
            <CardContent>
                ...
                >
                  ...
                  {settings.template &&
                    elements.map((element) => {
                      const position =
                        settings.positions[
                          element.key as keyof typeof settings.positions
                        ];
                        ...
                        <div
                          ...
                          className={`absolute border-2 border-dashed ${
                            activeElement === element.key
                              ...
                              : "border-gray-400"
                          } cursor-move flex items-center justify-center text-xs font-medium ${
                            element.color
                          } transition-colors ${
                          ...
                          style={{
                            ...
                            top: `${
                              (position.y / containerRect.height) * 100
                            }%`,
                            width: `${
                              ((position.width || 100) / containerRect.width) *
                              100
                            }%`,
                            height: `${
                              ((position.height || 30) / containerRect.height) *
                              100
                            }%`,
                            minWidth: "60px",
                            minHeight: "20px",
              ...
              <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                <p className="text-sm text-blue-700">
                  💡 اسحب العناصر لتغيير مواضعها - التوقيع سيظهر كصورة حقيقية
                  عند رفعه
                </p>
              </div>
            </CardContent>
