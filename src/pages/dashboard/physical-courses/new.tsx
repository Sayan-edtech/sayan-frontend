...
import { Save, Image as ImageIcon, FolderOpen, ArrowRight, Calendar, Clock, User, Video, Plus, Trash2, MapPin, DollarSign } from "lucide-react";
...
// Validation schema for the physical course form
const physicalCourseSchema = z.object({
...
type PhysicalCourseFormData = z.infer<typeof physicalCourseSchema>;

export default function NewPhysicalCourse() {
  ...
  const {
    ...
    setValue,
    getValues
  } = useForm<PhysicalCourseFormData>({
  ...
  const onSubmit = async (data: PhysicalCourseFormData, status: 'draft' | 'published' = 'published') => {
    ...
    try {
      // TODO: استدعاء API لحفظ الدورة الحضورية عبر src/services/apiService.ts
      console.log("Physical course data:", submissionData);
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            ...
            <div className="space-y-6">
              ...
              {/* Course Title and Location in same row */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <FormFields 
                    name="title"
                    label="عنوان الدورة *"
                    type="text"
                    placeholder="مثال: ورشة الأمن السيبراني"
                    control={control} 
                    errors={errors} 
                  />
                </div>
                <div>
                  <FormFields 
                    ...
                    label="الموقع *"
                    type="text"
                    placeholder="مثال: مقر الأكاديمية - القاعة الرئيسية"
                    control={control} 
                    errors={errors} 
                  />
                </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            ...
            <div className="space-y-6">
              {/* Video Upload (Required) - Removed since moved to Basic Information */}
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900">جلسات الدورة</h3>
                <p className="text-sm text-gray-500">أضف الجلسات التدريبية للدورة</p>
              </div>
            </div>
            <Button
              type="button"
